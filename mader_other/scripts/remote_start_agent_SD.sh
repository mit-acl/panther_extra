...
tmux send-keys -t $SESSION:0.6 "cd /media/sdcard/bags && rosbag record -o sd /HX09/state /HX09/log /HX09/image_raw/compressed /HX09/vio/map_points /HX09/motors /HX09/log /HX09/state" C-m
